...
return [
  'custom' => [
    ...
    'pageHeader' => true, //options:Boolean: false(default), true (Page Header for Breadcrumbs) Warning:if page header true need to define a breadcrumbs in controller
    ...
    'templateTitle' => 'GISELLE', //template Title can be changed, default(Frest)
